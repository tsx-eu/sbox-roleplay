...
namespace SWB_CSS
{
	[Library( "swb_hands", Title = "Hands" )]
	public class Hands : WeaponBaseMelee
	{
		public override int Bucket => 0;
		public override HoldType HoldType => HoldType.Pistol;
		public override string ViewModelPath => "weapons/fists/v_fists.vmdl";
		public override string WorldModelPath => "weapons/fists/v_fists.vmdl";
		public override string HandsModelPath => "weapons/rust_hands/rust_hands.vmdl";
